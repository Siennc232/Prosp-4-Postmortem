...
One cover-rule change illustrates the process. The `delay70_cancel6` sweep used a 70-tick voucher-cover delay and a cancellation threshold of 6. It added 18,131 over three days versus its baseline. It improved all three days, with the weakest daily gain still +2,081. The worst drawdown remained -15,772. This was an early research control; the final implementation later added separate late-session rules.

I compared candidates by full-day PnL, per-day results, drawdown, and stress scenarios. The [decision audit](data/r4_balanced_vs_maxraw_acceptance.csv) records 201,435.5 over three days for the maximum-return reference and 198,915.5 for the balanced final. Under the stress +200 test, the balanced version made 43,715.5 versus 34,235.5. I accepted the 2,520 reduction in headline PnL to reduce late voucher concentration.
